...
class TestModelConfig:
    ...
    def valid_config_section(self):
        return {"embedding_dim": 64, "lstm_units": 128, "dropout": 0.5}
    ...
    def test_parse_config_sets_expected_dropout_given_none_given(self):
        config = ModelConfig.parse_config({"embedding_dim": 64, "lstm_units": 128})
